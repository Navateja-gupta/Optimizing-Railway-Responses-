...
def ac_add(uname,post,type):
    try:
        ...
        print("*********************************************")
        print(type1)
        j = c.execute("insert into complaints (name, post,category, comment,type) values ('"+uname+"','"+post+"','"+type1+"','"+comment1+"','"+type1+"')")
        conn.commit()
        conn.close()
        print(j)
        return j
...
def vcomp1(uname,post,sol):
    try:
        ...
        j = c.execute("update complaints set comment='solved',type='"+sol+"' where name='"+uname+"' and post='"+post+"'  ")
        conn.commit()
        conn.close()
        print(j)
        return j
...
def vm1(username):
    c, conn = db_connect()
    c.execute("select * from complaints where name='"+username+"' and comment='solved'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result

def viewcomp4(uname,post):
    c, conn = db_connect()
    c.execute("select * from complaints where name='"+uname+"' and post='"+post+"'  ")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def viewcomp1(type):
    cc="pending"
    c, conn = db_connect()
    c.execute("SELECT * FROM complaints WHERE category='"+type+"' ")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis1():
    c, conn = db_connect()
    c.execute("select count(post) from complaints where category='food'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis2():
    c, conn = db_connect()
    c.execute("select count(post) from complaints where category='ticket'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis3():
    c, conn = db_connect()
    c.execute("select count(post) from complaints where category='medical'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis4():
    c, conn = db_connect()
    c.execute("select count(post) from complaints where category='security'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis8():
    c, conn = db_connect()
    c.execute("select count(post) from complaints where category='maintenence'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis9():
    c, conn = db_connect()
    c.execute("select count(post) from complaints where category='travel'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis5():
    c, conn = db_connect()
    c.execute("select count(type) from complaints where comment='solved'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def analysis6():
    c, conn = db_connect()
    c.execute("select count(type) from complaints where comment='pending'")
    result = c.fetchall()
    conn.close()
    print("result")
    return result
...
def complaints_log(username, password,type):
    try:
        c, conn = db_connect()
        j = c.execute("select * from comp where username='" +
...
def analyst_log(username, password):
    try:
        c, conn = db_connect()
