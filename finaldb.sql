...
insert  into `complaints`(`name`,`post`,`category`,`comment`,`type`) values ('chotu','i have food problem','food','solved','will replace'),('chotu','i have ticket issue','ticket','pending','Feedback'),('raj','my reserved ticket was been allotted to RAC passenger as we boarded from next station. Kindly please help ??','ticket','solved','problem soved');
...
CREATE TABLE `post` (
  `name` varchar(100) DEFAULT NULL,
  `post` varchar(1000) DEFAULT NULL,
  `comment` varchar(1000) DEFAULT 'pending',
  `type` varchar(100) DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `post` */

insert  into `post`(`name`,`post`,`comment`,`type`) values ('raj','my reserved ticket was been allotted to RAC passenger as we boarded from next station. Kindly please help ??','pending','tickets');
